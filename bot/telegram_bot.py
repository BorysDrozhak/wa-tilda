...
ONBOARDING_LINKS = {
    ...
    'бармен': '',
    'адмін': 'https://docs.google.com/document/d/1qGhkanahbioCGuDD7qVorPh96O610gKpZ1QCP9KVIl0/edit',
...
взяти до уваги 😉
Пишемо враження про гостей, чи їм усе сподобалось
і чи були фідбеки про сервіс.'''
